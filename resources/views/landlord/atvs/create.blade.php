            ...
            <div class="col-md-12">
                <div class="card mt-5">
                    ...
                    <div class="card-body">
                        ...
                        <form action="{{ route('landlord.atv.store') }}" method="POST" enctype="multipart/form-data">
                            @csrf
                            <div class="form-group">
                                <label for="name" style="color:#14455F;">Name: </label>
                                <input type="text" class="form-control" required placeholder="Enter area name" id="name"
                                    name="name" value="{{ old('name') }}">
                            </div>
                            @php
                                $houses = App\House::where('user_id',Auth::user()->id)->where('status', 1)->get();
                            @endphp
                            <div class="form-group">
                                <label for="house_id" style="color:#14455F;">House: </label>
                                <select name="house_id" required id="house_id" class="form-control">
                            ...
                            <div class="form-group">
                                ...
                                <input type="file" required class="form-control" id="main_image" name="main_image">
                            </div>

                            <div class="form-group">
                                <label for="min_age" style="color:#14455F;">Min Age Range: </label>
                                <input type="number" required class="form-control" placeholder="Enter Min Age Range" id="min_age"
                                    name="min_age" value="{{ old('min_age') }}">
                            </div>

                            <div class="form-group">
                                <label for="atv_experience" style="color:#14455F;">ATV Experince: </label>
                                <input type="text" required class="form-control" placeholder="Enter ATV Experince"
                                    id="atv_experience" name="atv_experience" value="{{ old('atv_experience') }}">
                            </div>

                            <div class="form-group">
                                <label for="total_passenger" style="color:#14455F;">Total Passanger Limit: </label>
                                <input type="number" required class="form-control" placeholder="Enter Total Passanger Limit"
                                    id="total_passenger" name="total_passenger" value="{{ old('total_passenger') }}">
                            </div>

                            <div class="form-group">
                                <label for="damage_deposit" style="color:#14455F;">Damage Deposite: </label>
                                <input type="number" required class="form-control" placeholder="Enter Damage Deposite"
                                    id="damage_deposit" name="damage_deposit" value="{{ old('damage_deposit') }}">
                            </div>

                            <div class="form-group">
                                <label for="description" required style="color:#14455F;">Description: </label>
                                <textarea class="form-control" id="description" name="description" value="{{ old('description') }}"></textarea>
                            </div>
                            <div class="form-group">
                                <label for="sub_description" required style="color:#14455F;">Sub Description: </label>
